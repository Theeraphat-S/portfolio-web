    ...
    <AnimatePresence onExitComplete={handleExitComplete}>
      {!isFinished && (
        ...
        >
          ...
          <div
            className="absolute inset-0 bg-[radial-gradient(circle,_#ffffff18_1px,_transparent_1px)] [background-size:24px_24px] pointer-events-none"
            aria-hidden="true"
          />

          {/* SVG Cursive Handwriting "hello" */}
          <div className="relative flex flex-col items-center justify-center w-full max-w-[420px] px-8">
            <svg
              className="text-white h-20 sm:h-24 md:h-28 w-auto filter drop-shadow-[0_0_18px_rgba(255,255,255,0.45)] drop-shadow-[0_0_40px_rgba(255,255,255,0.18)]"
            ...
            >
              <title>hello</title>
              {/* Stroke 1: Initial cursive 'h' entry and stem */}
              <motion.path
              ...
              />
              {/* Stroke 2: Arch of 'h' connecting through 'e-l-l-o' with flourish */}
              <motion.path
